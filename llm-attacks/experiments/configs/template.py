...
def get_config():
    ...
    # tokenizers
    config.tokenizer_paths=['/root/autodl-tmp/zhc/llm-attacks/data/vicuna/vicuna-7b-v1.3']
    config.tokenizer_kwargs=[{"use_fast": False}]
    
    config.model_paths=['/root/autodl-tmp/zhc/llm-attacks/data/vicuna/vicuna-7b-v1.3']
